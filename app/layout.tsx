...
export const metadata: Metadata = {
  title: "Fazlul Hoque | Full Stack Developer",
  description:
    "Portfolio of Fazlul Hoque - Full Stack Developer specializing in modern web applications with React, Next.js, and Node.js",
}
